...
[RCh1(TrajToRetrive,:) RCh2(TrajToRetrive,:) RChSum(TrajToRetrive,:) RCrosscorr(TrajToRetrive,:) RChPol(TrajToRetrive,:) k(TrajToRetrive,:)]=BinaryAoutoCorr_V7(DataSelectionRules,TTTRCh1Time{TrajToRetrive},TTTRCh2Time{TrajToRetrive},Res,points);
...
Trajobject.TTTTRTrajs.Autocorrelation.RChPol=RChPol;
