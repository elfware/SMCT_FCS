function [msd,coeffDiffComponents] = getDiffMSDCamera(trajs,timeStep,pixelSize,Dimension,numberOfdeltaT)
...
for j=1:Dimension
    msd{j}=zeros(numtrajs,numberOfdeltaT);
end
    for i=1:numtrajs
        for j=1:Dimension
...
%                msdN = nData-length(squaredDisplacement); %# n
            ...
            t=timeStep:timeStep:numberOfdeltaT*timeStep;
            tempfit=polyfit(t/1000,msd{j}(i,1:numberOfdeltaT),1);
