function [slidingInd,notstuck,angles,rellat,trajPrinclatent,thescores,okLength,trajL] = slidingClassifyPCACameraTemplatever12_5(Trajectories,DataSelectionRules,classparams,p)
