function [corrfunc] = corrFuncMultExpBgbExtra3_normInds(aBgVec,kBgVec,bExtra,k,tVec,t3,normInds)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
%k2=-k*D/p^2;
%Specify normInds instead of normnumber, for plotting
numBg=numel(aBgVec);
numT=numel(tVec);
k2=k;
expT1=exp(k2*tVec);
