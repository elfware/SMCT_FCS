function Trajobject=ProcessTTTRData(Scanobjects,Trajobject,Ind, AutoCorrelationParam,TimeDiffParam)
...
%[RCh1(TrajToRetrive,:) Res(TrajToRetrive,:)]=BinaryAoutoCorr_V4(TTTRCh1Pos,TTTRCh2Pos,points,Binning);
%[RCh2(TrajToRetrive,:) Res(TrajToRetrive,:)]=BinaryAoutoCorr_V4(TTTRCh2Pos,points,Binning);
%RCh1(TrajToRetrive,:)=BinaryAoutoCorr(TTTRCh1Pos,points,Res);
%RCh2(TrajToRetrive,:)=BinaryAoutoCorr(TTTRCh2Pos,points,Res);
