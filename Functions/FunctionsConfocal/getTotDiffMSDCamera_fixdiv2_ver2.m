function [msd,coeffDiffComponents] = getTotDiffMSDCamera_fixdiv2_ver2(trajs,timeStep,pixelSize,Dimension,startPoint,endPoint)
...
for j=1:Dimension
    ...
    for dt = 1:endPoint
        ...
        msdNt = nData-length(squaredDisplacement); %# n
        msd{j}(dt) = msdMean;
        msdStd{j}(dt)=msdStdt;
        msdN{j}(dt)=msdNt;
    end
