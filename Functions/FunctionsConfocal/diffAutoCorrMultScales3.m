function [diff] = diffAutoCorrMultScales3(aVec,kVec,autoCorrScaledBg,autoCorrs,lagTimes,normNumber)
...
for i=1:numScales
  ...
  %diff((i-1)*numTimes+1:(i-1)*numTimes+numTimes)=corrFuncMultExpBgbExtra(aVec,kVec,bExtra(i),-inf,lagTimes(i,:),lagTimes(i,end),normNumber)-autoCorrs(i,:);
