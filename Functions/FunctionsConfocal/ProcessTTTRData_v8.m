function Trajobject=ProcessTTTRData_v8(Scanobjects,Trajobject,Ind, AutoCorrelationParam,p)
...
[RCh1(TrajToRetrive,:) RCh2(TrajToRetrive,:) RChSum(TrajToRetrive,:) RChCross(TrajToRetrive,:) k(TrajToRetrive,:)]=BinaryAoutoCorr_V9(DataSelectionRules,TTTRCh1Time{TrajToRetrive},TTTRCh2Time{TrajToRetrive},B,ncas,TTTRRes);
