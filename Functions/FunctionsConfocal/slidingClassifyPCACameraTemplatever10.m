function [slidingInd,notstuck,angles,rellat,trajPrinclatent,thescores] = slidingClassifyPCACameraTemplatever10(Trajectories,DataSelectionRules,classparams,p)
