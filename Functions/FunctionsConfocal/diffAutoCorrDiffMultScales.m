function [diff] = diffAutoCorrDiffMultScales(aVec,kVec,bExtra,kFactor,autoCorrsDiff,lagTimes,normNumber)
...
for i=1:numScales
  ...
  TheoryDiff=corrFuncMultExpBgbExtra(aVec,kVec,bExtra(i),-inf,lagTimes(i,:),lagTimes(i,end),normNumber)-corrFuncMultExpBgbExtra(aVec,kVec.*kFactor,bExtra(i),-inf,lagTimes(i,:),lagTimes(i,end),normNumber);
