function Trajobject=ProcessTTTRData_v10(Scanobjects,Trajobject,Ind, AutoCorrelationParam,extraTLags,p)
...
[RCh1(TrajToRetrive,:) RCh2(TrajToRetrive,:) RChSum(TrajToRetrive,:) RChCross(TrajToRetrive,:) k(TrajToRetrive,:)]=BinaryAoutoCorr_V11(DataSelectionRules,TTTRCh1Time{TrajToRetrive},TTTRCh2Time{TrajToRetrive},B,ncas,extraTLags,TTTRRes);
