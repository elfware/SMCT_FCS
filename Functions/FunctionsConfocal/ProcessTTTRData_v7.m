function Trajobject=ProcessTTTRData_v7(Scanobjects,Trajobject,Ind, AutoCorrelationParam,p)
...
[RCh1(TrajToRetrive,:) RCh2(TrajToRetrive,:) RChSum(TrajToRetrive,:) k(TrajToRetrive,:)]=BinaryAoutoCorr_V8(DataSelectionRules,TTTRCh1Time{TrajToRetrive},TTTRCh2Time{TrajToRetrive},B,ncas,TTTRRes);
