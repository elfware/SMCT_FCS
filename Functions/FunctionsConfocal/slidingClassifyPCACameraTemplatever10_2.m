function [slidingInd,notstuck,angles,rellat,trajPrinclatent,thescores] = slidingClassifyPCACameraTemplatever10_2(Trajectories,DataSelectionRules,classparams,p)
...
% or not based on ard cutoffs in classparams
  ...
  for i=1:numtrajs
      ...
      [tempcoeff{i},thescores{i},trajPrinclatent(:,i)]=princomp(alltrajs);
