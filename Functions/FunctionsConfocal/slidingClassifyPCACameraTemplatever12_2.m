function [slidingInd,notstuck,angles,rellat,trajPrinclatent,thescores,okLength] = slidingClassifyPCACameraTemplatever12_2(Trajectories,DataSelectionRules,classparams,p)
...
%direction
  ...
  for i=1:numtrajs
    ...
    [~,compDiffMSD]=getDiffMSDCamera_ver2(thescores,classparams.deltat,classparams.scale,2,classparams.msdStartPoint,classparams.msdEndPoint);
