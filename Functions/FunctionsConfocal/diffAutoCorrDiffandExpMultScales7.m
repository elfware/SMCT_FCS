function [diff] = diffAutoCorrDiffandExpMultScales7(aVec,kVec,bExtra,kFactor,autoCorrsDiff,lagTimes,normNumber,autoCorrScaledBg1,autoCorrScaledBg2)
...
diff=zeros(1,numScales*numTimes);
 ...
 TheoryDiffCorrected=diffAutoCorrDiffMultScales3(1,kVec(1),bNew,kFactor,autoCorrsDiff,lagTimes,normNumber);
