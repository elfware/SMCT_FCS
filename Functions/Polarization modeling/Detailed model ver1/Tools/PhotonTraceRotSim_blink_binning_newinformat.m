function [IhExact IvExact IhDiscrete IvDiscrete]=PhotonTraceRotSim_blink_binning_newinformat(Param,Dr,dt,trajLength)
...
if strcmp(StringCom,'AddShutnoise')
    ...
    avgPhotonsT=reshape(avgPhotons,[size(avgPhotons,2) size(avgPhotons,3)]);
