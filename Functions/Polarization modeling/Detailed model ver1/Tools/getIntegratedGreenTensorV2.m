function [GsquaredX GsquaredY]=getIntegratedGreenTensorV2(Param)
...
%V2: Fixed so that green tensor is correctly set to 0 outside rhomax
...
thex=thextemp(1:end-1)+(thextemp(2)-thextemp(1))/2; %To get integration according to rectangle rule
