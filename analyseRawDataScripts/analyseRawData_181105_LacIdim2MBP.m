...
pathnamesold={'/Calibration_deg0_HRtoL/ScanData/'; ...
    '/Pos1M1_deg0_HRtoL_lockin13_release0,3/ScanData/'; ...
    '/Pos1M2_deg0_HRtoL_lockin13_release0,3/ScanData/'; ...
    '/Pos1M3_deg0_HRtoL_lockin13_release0,3/ScanData/'; ...
    '/Pos1M4_deg0_HRtoL_lockin13_release0,3/ScanData/'; ...
    '/Pos1M6_deg0_HRtoL_lockin13_release0,3/ScanData/'};
...
for Scanfiles=[2:6];%[1:size(pathnames,1)]
...
DataSelectionRules.Trajectory.BackgroundThrechold=4;%[counts] is the minimum photon count what we like to interpret as a signal, this is used for calculating a real background
...
%save('ScanTrajData_deg_0_B1ncas22_Main_v10_BackgroundThrechold_4.mat','-v7.3','Scanobjects', 'Trajobject','TimeDiffParam','AutoCorrelationParam','Ind','slidingVector','notstuck','angles','rellat','trajPrinclatent','slidingInd')
